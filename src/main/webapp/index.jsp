...
<header>
	...
	<h3><center>Welcome to Warakagoda Tea Factory!!</center></h1>
			...
			<center>
				<br/>
				<a href = "add_vehicle.jsp">Add a vehicle</a>
				<br/>
				<a href = "update_or_edit_vehicle.jsp">Update or Delete a vehicle</a>
				<br/>
				<a href = "assign_a_vehicle.jsp">Assign a vehicle</a>
				<br/>
				<a href = "weeklyReport">Weekly transportation schedule</a>
				<br/>
				<a href = "inventoryNotification">Inventory level notification</a>
				<br/>
				<a href = "trackOrder1">Track Order and update status</a>
				<br/>
				<a href = "generateMonthlyPurchaseReport">Generate Monthly Purchase Report</a>
			</center>
